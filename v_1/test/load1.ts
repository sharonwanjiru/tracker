    ...
    extends outlook.terminal 
{
    ...
    async check(): Promise<boolean> {
        //
        //Get the table args.
        const rooms:Array<quest.layout> = this.get_room_layouts();
        //
        //Get the clients.
        const clients:Array<quest.layout> = this.get_client_layouts();
        //
    ...
    get_room_layouts(): Array<quest.layout>{
        //
        ...
        const dest: Array<quest.label> = cnames.map(cname =>
            [this.dbname, tname, [tname], cname, [this.table, tname, cname]]        
        );
        //
    ...
    get_client_layouts(): Array<quest.layout> {
        //
        //Get the table name.
        const tname = "client";
        //
